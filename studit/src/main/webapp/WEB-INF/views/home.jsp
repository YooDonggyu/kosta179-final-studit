...
<section class="engine"><a href="https://mobirise.me/q">free responsive site templates</a></section>
<section class="counters1 counters cid-qRwHqGEgSS" id="counters1-1c">
    <div class="mbr-overlay" style="opacity: 0.4; background-color: rgb(135, 154, 159);"></div>

    <div class="container">
        <h2 class="mbr-section-title pb-3 align-center mbr-fonts-style display-1 main-title"><strong>STUD-IT</strong></h2>
        <h3 class="mbr-section-subtitle mbr-fonts-style display-5">Mobirise is a beautiful site constructor</h3>
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-3">
                <div class="card-wrapper ">
                    <div class="card-img">
                        ...
                        <img src="${pageContext.request.contextPath }/resources/assets/images/01.jpg" alt="Mobirise">
                    </div>
                    <div class="card-box">
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-3">
                <div class="card-wrapper">
                    <div class="card-img">
                        ...
                        <img src="${pageContext.request.contextPath }/resources/assets/images/02.jpg" alt="Mobirise">
                    </div>
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-7">
                            Mobile Friendly
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-3">
                <div class="card-wrapper">
                    <div class="card-img">
                        ...
                        <img src="${pageContext.request.contextPath }/resources/assets/images/03.jpg" alt="Mobirise">
                    </div>
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-7">
                            Unique Styles
...
<section class="mbr-section article content11 cid-qRwLGPCXmI" id="content11-1q">
    <div class="container">
        <div class="media-container-row">
