...
<div class="row">
	<div class="col-sm-11">
		<h3>STUD-IT 스터디룸 추가</h3>
		<p>업체에서 보유 중인 스터디룸의 정보를 입력해주세요.</p>
	</div>
</div>
	<div class="col-sm-1" ></div>
	<div style="padding-left:0px;">
<form action="${pageContext.request.contextPath }/studyroom/registerStudyRoom?companyNo=${cno}&memberEmail=${memberVO.memberEmail}&companyName=${cname}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
	<div id="step3"><br><br>
    	 <div class="form-group">
          ...
          <div class="form-group">
              ...
              <div class="col-sm-7 text-left">
                  <textarea id="content" name="content" class="noresize" rows="6" cols="72" maxlength="179" required="required" placeholder="스터디룸에 대해 소개해주세요. (ex_이용인원, 목적 등)"></textarea>
              </div>
          </div>
