package org.kosta.studit.model;

public class CompanyPagingBean {
	private int nowPage = 1;
	 /**
	  * 페이지당 게시물수
	  */
	 public int postCountPerPage = 3;
	 /**
	  * 페이지 그룹당 페이지수
	  */
	...
	public CompanyPagingBean() {
	 ...
	 public CompanyPagingBean(int totalPostCount) {
	  this.totalPostCount = totalPostCount;
	 }

	 public CompanyPagingBean(int totalPostCount, int nowPage) {
	  this.totalPostCount = totalPostCount;
